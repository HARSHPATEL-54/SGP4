...
import { Loader2, LockKeyhole, Mail, PhoneOutgoing, User, UserPlus, ChefHat } from "lucide-react";
            ...
            <form onSubmit={loginSubmitHandler} className="space-y-4">
              <div className="space-y-1">
                <div className="relative group">
                  ...
                  />
                  <User className="absolute left-3 top-3.5 text-gray-400 group-focus-within:text-orange-500 transition-colors duration-200" />
                </div>
                {errors.fullname && (
              ...
              <div className="space-y-1">
                <div className="relative group">
                  <Input
                    ...
                    className="pl-10 h-12 bg-gray-50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 focus-visible:ring-orange-500 transition-all duration-200 rounded-lg"
                  />
                  <PhoneOutgoing className="absolute left-3 top-3.5 text-gray-400 group-focus-within:text-orange-500 transition-colors duration-200" />
                </div>
                {errors.contact && (
                  <span className="text-xs font-medium text-red-500 pl-1 animate-slideDown">
                    {errors.contact}
